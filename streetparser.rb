...
streets = ["Aakamp",
           ...
           "Berliner Platz",
           "Bermestraße",
           "Bernd-Feldhaus-Platz",
           "Bernhard-Ernst-Straße",
           "Bernhard-Poether-Straße",
           "Bernhardstraße",
           "Bernings Kotten",
           "Bernsmeyerstiege",
...
re = Regexp.union(streets)

str = ""
for i in 2300..2400
    open("http://localhost:3333/documents/#{i}") {|f|
        f.each_line {|line|
        #str << line
          #/^([a-zäöüÄÖÜß\ \.\-]+?)(\ +)(\d+\ *[a-z]*)/i
        if street = line.match(re)
            p i
            p street
            p line
        end
...
=begin
print "Weiterer Betrieb des Gebäudes in Pavillonbauweise der Flüchtlingseinrichtung
